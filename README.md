# FridgeGroceryList
WIP ESP32 project using a small device with e-paper to make a Shopping list with Speak to text synchronized with a smartphone.   
...
- The list is synchronised on your phone.
